    ...
    <body>
        ...
        <main>
            ...
            <div class="form-container-full">
                ...
                <form action="./handlers/event-add.php" method="POST" enctype="multipart/form-data"
                    class="add-events interests-card-container-form">
                    ...
                    <img src="https://academy.edu.ly/default-images/program.jpg" alt="" id="previewImage">
                    <div class="input-container">
                        <span>Image : </span>
                        <div class="input-wrapper">
                            ...
                            <label for="imageInput" class="input-dialog-box-wrapper">
                                <p id="image-placeholder" class="no-icon">Select event poster</p>

                                <input type="file" id="imageInput"
                                    onchange="previewImageTag(event); setPlaceholder('imageInput','image-placeholder', 'Select event poster');"
                                    name="img" accept=".jpg, .jpeg, .png" max="5MB" required>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="input-container">
                        ...
                        <div class="input-wrapper">
                            <label for="DOB" class="input-dialog-box-wrapper">
                                <p id="date-of-birth-placeholder" class="no-icon">Select event date</p>
                    ...
                    <div class="input-container">
                        ...
                        <div class="input-wrapper">
                            <label for="Time" class="input-dialog-box-wrapper">
                                <p id="time-placeholder" class="no-icon">Select event time</p>
                    ...
                    <div class="button-wrapper">
                        <button class="submit-btn" type="submit" name="addEvent">
                            Add Event
                        </button>
                    </div>
