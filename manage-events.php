    ...
    <div class="card-container-wrapper event-page">
        ...
        <div class="card-container card-container-auto">
            ...
            <div class="card-wrapper">
                ...
                e.status,
                e.expired,
                SUM(ube.quantity) AS total_tickets_booked,
                SUM(ube.cost) AS total_income,
                ...
                WHERE e.user_id = ?
                GROUP BY e.id, e.image, e.name, e.location, e.date, e.tickets_count, e.status, e.expired
                ORDER BY e.expired");
                ...
                $stmt->bind_result($id, $image, $name, $location, $date, $tickets, $status, $expired, $totalBooked, $totalIncome, $totalViews);
                        ...
                        <div class="card">
                            ...
                            <div class="content-container">
                                ...
                                <div class="favourtite ft">
                                    <i class="svg-wrapper">
                                        ...
                                        if ($status == 0) {
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" height="1em"
                                                viewBox="0 0 512 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                <path style=" fill: green !important;"
                                ...
                                <div class="button-wrapper">
                                    <button
                                        onclick="window.location.href='manage-event.php?event_id=<?php echo $id ?>'">Details</button>
                                </div>
                            </div>
                        </div>
                    </div>
