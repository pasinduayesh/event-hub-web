    ...
    <div class="card-container-wrapper event-page">
        ...
        <div class="card-container card-container-auto">
            ...
            <div class="card-wrapper">
                ...
                $stmt = $conn->prepare("SELECT e.id, e.image, e.name, e.location, e.date, e.tickets_count, ube.quantity AS quantity
                FROM events AS e
                INNER JOIN userbookevent AS ube ON e.id = ube.event_id
                WHERE ube.user_id = ?");
                ...
                $stmt->bind_result($id, $image, $name, $location, $date, $tickets, $quantity);
                        ...
                        <div class="card">
                            ...
                            <div class="content-container">
                                ...
                                <div class="tickets ft">
                                    <span><?php echo $tickets ?> left</span>
                                    <i class="svg-wrapper">
                                ...
                                <div class="details-container">
                                    ...
                                    <div>
                                        ...
                                        <span><?php echo $quantity ?> tickets booked</span>
                                    </div>
                                ...
                                <div class="button-wrapper">
                                    <button onclick="window.location.href='event.php?event_id=<?php echo $id ?>'">Details</button>
                                </div>
                            </div>
                        </div>
                    </div>
